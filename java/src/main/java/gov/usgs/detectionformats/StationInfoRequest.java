...
/**
 * a conversion class used to create, parse, and validate a station information request
 *
...
public class StationInfoRequest {
  ...
  /** The constructor for the StationInfoRequest class. Initializes members to null values. */
  ...
  /**
   * The advanced constructor for the StationInfoRequest class. Initializes members to provided
   * values.
   *
  ...
  /**
   * The alternate advanced constructor for the StationInfoRequest class. Initializes members to
   * provided values.
   *
