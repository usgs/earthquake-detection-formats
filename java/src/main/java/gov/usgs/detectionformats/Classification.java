...
/**
 * a conversion class used to create, parse, and validate value added classification data from
 * advanced algorithms such as machine learning as part of detectionformats data.
 *
...
public class Classification implements DetectionInt {
  ...
  /**
   * An optional private final Double containing the probability of the classification phase name
   */
  ...
  /** An optional private final Double containing the probability of the classification distance */
  ...
  /**
   * An optional private final Double containing the probability of the classification backazimuth
   */
  ...
  /** An optional private final String containing the classification magnitude type */
  private final String magnitudeType;

  /** An optional private final Double containing the probability of the classification magnitude */
  private final Double magnitudeProbability;

  /** An optional private final Double containing the classification depth */
  private final Double depth;

  /** An optional private final Double containing the probability of the classification depth */
  private final Double depthProbability;

  /** An optional EventType containing the classification event type */
  private final EventType eventType;

  /**
   * An optional private final Double containing the probability of the classification event type
   */
  ...
  /** The constructor for the Classification class. Initializes members to null values. */
   ...
   *
   * <p>The advanced constructor for the Classification class. Initializes members to provided
   * values.
   *
   * @param newPhase - A String containing the phase name to use (null omit)
   * @param newPhaseProb - A Double containing the probability of the phase estimate (null omit)
   * @param newDistance - A private final Double containing the distance to use (null omit)
   * @param newDistanceProb - A Double containing the probability of the distance estimate (null
   *     omit)
   * @param newBackazimuth - A private final Double containing the backazimuth to use (null omit)
   * @param newBackazimuthProb - A Double containing the probability of the backazimuth estimate
   *     (null omit)
   * @param newMagnitude - A Double containing the magnitude to use (null omit)
   * @param newMagType - A String containing the magnitude type to use (null omit)
   * @param newMagProb - A Double containing the probability of the magnitude estimate (null omit)
   * @param newDepth - A Double containing the depth to use (null omit)
   * @param newDepthProb - A Double containing the probability of the depth estimate (null omit)
   * @param newEventType - A String containing the event type to use (null omit)
   * @param newEventTypeCertainty - A String containing the event type certainty to use (null omit)
   * @param newEventTypeProb - A Double containing the probability of the event type estimate (null
   *     omit)
   * @param newAgencyID - A String containing the classifing agency id to use (null omit)
   * @param newAuthor - A String containing the classifing author to use (null omit)
   */
  public Classification(
      String newPhase,
      Double newPhaseProb,
      Double newDistance,
      Double newDistanceProb,
      Double newBackazimuth,
      Double newBackazimuthProb,
      Double newMagnitude,
      String newMagType,
      Double newMagProb,
      Double newDepth,
   ...
   *
   * <p>The alternate advanced constructor for the Classification class. Initializes members to
   * provided values.
   *
   * @param newPhase - A String containing the phase name to use (null omit)
   * @param newPhaseProb - A Double containing the probability of the phase estimate (null omit)
   ...
   * @param newDepth - A Double containing the depth to use (null omit)
   * @param newDepthProb - A Double containing the probability of the depth estimate (null omit)
   * @param newEventType - An EventType object containing the event type to use (null omit)
   * @param newEventTypeProb - A Double containing the probability of the event type estimate (null
   *     omit)
   * @param newSource - A Source object classifing source to use (null omit)
   */
  public Classification(
      String newPhase,
      Double newPhaseProb,
  ...
  public Classification(JSONObject newJSONObject) {
    ...
    if (newJSONObject.containsKey(DEPTHPROB_KEY)) {
      depthProbability = (double) newJSONObject.get(DEPTHPROB_KEY);
    } else {
      depthProbability = null;
    }
