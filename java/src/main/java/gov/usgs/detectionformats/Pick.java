...
public class Pick implements DetectionInt {
   ...
   * @param newPhase - A String containing the phase to use, null to omit
   * @param newPolarity - A String containing the polarity to use, empty String to omit
   * @param newOnset - A String containing the onset to use, null to omit
   * @param newPicker - A String containing the picker to use, null to omit
   ...
   * @param newAmplitude - A Double containing the amplitude to use, null to omit
   * @param newPeriod - A Double containing the period to use, null to omit
   ...
   * @param newAssociationPhase - A std:Stringcontaining the associated phase to use, null to omit
   ...
   * @param newClassificationPhase - A String containing the phase name to use, null to omit
   * @param newClassificationPhaseProb - A Double containing the probability of the phase estimate,
   *     null to omit
   * @param newClassificationDistance - A Double containing the distance to use, null to omit
   * @param newClassificationDistanceProb - A Double containing the probability of the distance
   *     estimate, null to omit
   * @param newClassificationBackazimuth - A Double containing the backazimuth to use, null to omit
   * @param newClassificationBackazimuthProb - A Double containing the probability of the
   *     backazimuth estimate, null to omit
   * @param newClassificationMagnitude - A Double containing the magnitude to use, null to omit
   * @param newClassificationMagType - A String containing the magnitude type to use, null to omit
   * @param newClassificationMagProb - A Double containing the probability of the magnitude
   *     estimate, null to omit
   * @param newClassificationDepth - A Double containing the depth to use, null to omit
   * @param newClassificationDepthProb - A Double containing the probability of the depth estimate,
   *     null to omit
   * @param newClassificationEventType - A String containing the event type to use, null to omit
   * @param newClassificationEventTypeCertainty - A String containing the event type certainty to
   *     use, null to omit
   * @param newClassificationEventTypeProb - A Double containing the probability of the event type
   *     estimate, null to omit
   * @param newClassificationAgencyID - A String containing the classifying algorithm agencyid to
   *     use, null to omit
   * @param newClassificationAuthor - A String containing the classifying algorithm author to use,
   *     null to omit
   */
  public Pick(
      String newID,
      ...
      String newClassificationPhase,
      Double newClassificationPhaseProb,
      Double newClassificationDistance,
      Double newClassificationDistanceProb,
      Double newClassificationBackazimuth,
      Double newClassificationBackazimuthProb,
      Double newClassificationMagnitude,
      String newClassificationMagType,
      Double newClassificationMagProb,
      Double newClassificationDepth,
      Double newClassificationDepthProb,
      String newClassificationEventType,
      String newClassificationEventTypeCertainty,
      Double newClassificationEventTypeProb,
      String newClassificationAgencyID,
    ...
    this(
        ...
        new ArrayList<Filter>(
            Arrays.asList(new Filter(newType, newHighPass, newLowPass, newUnits))),
        ...
        new Association(
            ...
            newAssociationSigma),
        new Classification(
            newClassificationPhase,
            newClassificationPhaseProb,
            newClassificationDistance,
            newClassificationDistanceProb,
            newClassificationBackazimuth,
            newClassificationBackazimuthProb,
            newClassificationMagnitude,
            newClassificationMagType,
            newClassificationMagProb,
            newClassificationDepth,
            newClassificationDepthProb,
            newClassificationEventType,
            newClassificationEventTypeCertainty,
            newClassificationEventTypeProb,
            newClassificationAgencyID,
   ...
   * @param newAuthor - A String containing the author to use
   * @param newPhase - A String containing the phase to use, null to omit
   * @param newPolarity - A String containing the polarity to use, null to omit
   * @param newOnset - A String containing the onset to use, null to omit
   * @param newPicker - A String containing the picker to use, null to omit
   * @param newType - A String containing the filter type to use (null omit)
   * @param newHighPass - A Double containing the highPass to use (null omit)
   ...
   * @param newOnset - A String containing the onset to use, null to omit
   * @param newPicker - A String containing the picker to use, null to omit
   * @param newFilter - An ArrayList&lt;Filter&gt; objects containing the filters to use, null to
   *     omit
   * @param newAmplitude - An Amplitude object containing the amplitude to us, null to omit
   * @param newBeam - A Double containing the amplitude to us, null to omit
   */
  public Pick(
      String newID,
      Site newSite,
   ...
   * @param newOnset - A String containing the onset to use, null to omit
   * @param newPicker - A String containing the picker to use, null to omit
   * @param newFilter - A Double containing the filter to use, null to omit
   * @param newAmplitude - An Amplitude object containing the amplitude to us, null to omit
   * @param newBeam - A Double containing the amplitude to us, null to omit
   * @param newAssociation - A Association containing the association info to use, null to omit
   * @param newClassification - A Classification containing the classification info to use, null to
   *     omit
   */
  public Pick(
      String newID,
  ...
  public Pick(JSONObject newJSONObject) {
    ...
    if (newJSONObject.containsKey(AMPLITUDE_KEY)) {
      amplitude = new Amplitude((JSONObject) newJSONObject.get(AMPLITUDE_KEY));
    } else {
      amplitude = null;
    }
    ...
    if (newJSONObject.containsKey(BEAM_KEY)) {
      beam = new Beam((JSONObject) newJSONObject.get(BEAM_KEY));
    } else {
      beam = null;
    }
    ...
    if (newJSONObject.containsKey(CLASSIFICATIONINFO_KEY)) {
      classificationInfo =
          new Classification((JSONObject) newJSONObject.get(CLASSIFICATIONINFO_KEY));
    } else {
      classificationInfo = null;
    }
  }
  ...
  public JSONObject toJSON() {
    ...
    // classification
    if ((jsonClassificationInfo != null) && (!jsonClassificationInfo.isEmpty())) {
      newJSONObject.put(CLASSIFICATIONINFO_KEY, jsonClassificationInfo.toJSON());
    }
