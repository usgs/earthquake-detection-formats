...
public class EventType implements DetectionInt {
	...
	/**
	 * The advanced constructor for the EventType class. Initializes members to
	 * provided values.
	 *
	 * @param newType
	 *            - A String containing the event type to use
	 * @param newCertainty
	 *            - A String containing the certainty to use
	 */
