...
public class Amplitude implements DetectionInt {
	...
	/**
	 * The constructor for the Amplitude class. Initializes members to null
	 * values.
	 */
	public Amplitude() {
	...
	/**
	 * The advanced constructor for the Amplitude class. Initializes members to
	 * provided values.
	 * 
	 * @param newAmplitude
	 *            - A double containing the Amplitude to use (null omit)
	 * @param newPeriod
	 *            - A double containing the Period to use (null omit)
	 * @param newSNR
	 *            - A double containing the SNR to use (null omit)
	 */
	public Amplitude(final Double newAmplitude, final Double newPeriod,
			final Double newSNR) {
	...
	public Amplitude(JSONObject newJSONObject) {
		...
		if (newJSONObject.containsKey(AMPLITUDE_KEY)) {
			amplitude = Double.valueOf(newJSONObject.get(AMPLITUDE_KEY)
					.toString());
		} else {
			amplitude = null;
		}
