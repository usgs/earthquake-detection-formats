...
class TestSite(unittest.TestCase):
    ...
    DICT = {'Channel': 'BHZ', 'Location': '00', 'Network': 'US', 'Station': 'BOZ', "Latitude": 45.6, "Longitude": 111.5, "Elevation": 12.5}
    ...
    def test_init(self):
        ...
        site = detectionformats.site.Site(self.STATION, self.NETWORK,
            self.CHANNEL, self.LOCATION, self.LATITUDE, self.LONGITUDE, 
            self.ELEVATION)
