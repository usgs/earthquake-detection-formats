...
class TestDetection(unittest.TestCase):
    ...
    DICT = {
        ...
        "DetectionTime": "2018-02-06T12:31:59.000Z",
        "Bayes": 2.5,
        "MinimumDistance": 1.2,
        "RMS": 5.6,
        "Gap": 1.0,
    ...
    def test_init(self):
        ...
        self.assertEqual(
            detection.hypocenter.latitudeError, self.HYPOCENTER.latitudeError
        )
        self.assertEqual(
            detection.hypocenter.longitudeError, self.HYPOCENTER.longitudeError
        )
