...
class TestStationInfo(unittest.TestCase):
    ...
    DICT = {
        ...
        "Enable": True,
        "UseForTeleseismic": True,
        "InformationRequestor": {"AgencyID": "testAgency", "Author": "testAuthor"},
    }
    ...
    def test_init(self):
        ...
        self.assertEqual(
            ...
            self.INFORMATIONREQUESTOR.agencyID,
        )
        self.assertEqual(
            stationinfo.informationRequestor.author, self.INFORMATIONREQUESTOR.author
        )
