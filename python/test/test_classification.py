...
class TestClassification(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(
            classification.backAzimuthProbability, self.BACKAZIMUTHPROBABILITY
        )
    ...
    def test_isValid(self):
        ...
        badClassification = detectionformats.classification.Classification(
            self.PHASE,
            self.PHASEPROBABILITY,
            -1,
            self.DISTANCEPROBABILITY,
