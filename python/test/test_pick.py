...
class TestPick(unittest.TestCase):
    ...
    CLASSIFICATIONINFO = detectionformats.classification.Classification(
        "P",
        12.5,
        22.0,
        88.2,
    ...
    DICT = {
        ...
        "Onset": "impulsive",
        "Picker": "other",
        "Amplitude": {"Amplitude": 5.5, "Period": 1.5, "SNR": 6.2},
        "Beam": {
            "BackAzimuth": 22.5,
            "Slowness": 1.2,
            "PowerRatio": 4.6,
            "BackAzimuthError": 1.2,
            "SlownessError": 3.5,
            "PowerRatioError": 2.1,
        },
        "Filter": [
            {"Type": "BandPass", "HighPass": 1.2, "LowPass": 0.2, "Units": "Hertz"}
        ],
        "AssociationInfo": {
            "Phase": "P",
            "Distance": 12.5,
        ...
        "ClassificationInfo": {
            "Phase": "P",
            "PhaseProbability": 12.5,
            "Distance": 22.0,
            "DistanceProbability": 88.2,
            "BackAzimuth": 45.0,
            "BackAzimuthProbability": 67.0,
            "Magnitude": 1.2,
            "MagnitudeType": "Mb",
            "MagnitudeProbability": 33.33,
            "Depth": 12.5,
            "DepthProbability": 50.2,
            "EventType": {"Type": "Earthquake", "Certainty": "Suspected"},
            "EventTypeProbability": 22.0,
            "Source": {"AgencyID": "testAgency", "Author": "testAuthor"},
        },
    }
    ...
    def test_init(self):
        ...
        self.assertEqual(
            ...
            self.CLASSIFICATIONINFO.phaseProbability,
        )
        self.assertEqual(
            pick.classificationInfo.distance, self.CLASSIFICATIONINFO.distance
        )
        self.assertEqual(
            pick.classificationInfo.distanceProbability,
            self.CLASSIFICATIONINFO.distanceProbability,
        )
        self.assertEqual(
            pick.classificationInfo.backAzimuth, self.CLASSIFICATIONINFO.backAzimuth
        )
        self.assertEqual(
            pick.classificationInfo.backAzimuthProbability,
            self.CLASSIFICATIONINFO.backAzimuthProbability,
        )
        self.assertEqual(
            pick.classificationInfo.magnitude, self.CLASSIFICATIONINFO.magnitude
        )
        self.assertEqual(
            pick.classificationInfo.magnitudeType, self.CLASSIFICATIONINFO.magnitudeType
        )
        self.assertEqual(
            pick.classificationInfo.magnitudeProbability,
            self.CLASSIFICATIONINFO.magnitudeProbability,
        )
        self.assertEqual(pick.classificationInfo.depth, self.CLASSIFICATIONINFO.depth)
        self.assertEqual(
            pick.classificationInfo.depthProbability,
            self.CLASSIFICATIONINFO.depthProbability,
        )
        self.assertEqual(
            pick.classificationInfo.eventType.type,
            self.CLASSIFICATIONINFO.eventType.type,
        )
        self.assertEqual(
            pick.classificationInfo.eventType.certainty,
            self.CLASSIFICATIONINFO.eventType.certainty,
        )
        self.assertEqual(
            pick.classificationInfo.eventTypeProbability,
            self.CLASSIFICATIONINFO.eventTypeProbability,
        )
    ...
    def test_fromJSON(self):
        ...
        self.assertEqual(
            ...
            self.CLASSIFICATIONINFO.source.agencyID,
        )
        self.assertEqual(
            pick.classificationInfo.source.author, self.CLASSIFICATIONINFO.source.author
        )
