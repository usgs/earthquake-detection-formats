...
namespace detectionformats
{
	...
	*
	* The detectionformats beam class is a conversion class used to create, parse, and
	* validate the unassociated beam data format beam.  The beam format uses
	...
	*/
	...
	public:
		...
		* \param newtime - A double containing the new time string to use
		* \param newbackazimuth - A double containing the back azimuth to use
		* \param newbackazimutherror - A double containing the back azimuth error to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newslowness - A double containing the slowness to use
		* \param newslownesserror - A double containing the slowness error to use, std::numeric_limits<double>::quiet_NaN() to omit
		*/
		beam(std::string newid, std::string newsiteid, std::string newstation, std::string newchannel, std::string newnetwork, std::string newlocation,
			     std::string newagencyid, std::string newauthor, double newtime, double newbackazimuth, double newbackazimutherror, double newslowness,
		...
		*/
		beam(std::string newid, std::string newsiteid, std::string newstation, std::string newchannel, std::string newnetwork, std::string newlocation,
			     std::string newagencyid, std::string newauthor, double newtime, double newbackazimuth, double newbackazimutherror, double newslowness,
			     double newslownesserror, std::string newassociatedphase, double newassociateddistance, double newassociatedazimuth, double newassociatedresidual,
		...
		* \param newslownesserror - A double containing the slowness error to use, std::numeric_limits<double>::quiet_NaN() to omit
		*/
		beam(std::string newid, detectionformats::site newsite, detectionformats::source newsource, double newtime, double newbackazimuth, 
		...
		*/
		beam(std::string newid, detectionformats::site newsite, detectionformats::source newsource, double newtime, double newbackazimuth,
			     double newbackazimutherror, double newslowness, double newslownesserror, detectionformats::associated newassociated);
		...
		* \brief beam site
		*
		* A required detectionformats::site containing the site for this beam message
		*/
		...
		* \brief beam source
		*
		* A required detectionformats::source containing the source for this beam message
		*/
		...
		* \brief beam time
		*
		* A required double containing the time for this beam message
		*/
		double time;
		...
		*
		* Optional detectionformats::associated containing the associated information for this beam message
		*/
