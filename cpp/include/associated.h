...
namespace detectionformats
{
	...
	*
	* The detectionformats associated class is a conversion class used to create, parse, and
	* validate associated data as part of detectionformats data.
	*
	*/
	...
	public:
		...
		*
		* \param newphase - A std::string containing the phase name to use, empty string to omit
		* \param newdistance - A double containing the distance to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newazimuth - A double containing the azimuth to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newresidual - A double containing the residual to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newsigma - A double containing the sigma to use, std::numeric_limits<double>::quiet_NaN() to omit
		*/
		associated(std::string newphase, double newdistance, double newazimuth, double newresidual, double newsigma);
		...
		*/
		associated(rapidjson::Value &json);
