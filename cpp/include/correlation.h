...
namespace detectionformats
{
	...
	*
	* The detectionformats correlation class is a conversion class used to create, parse, and
	* validate the unassociated correlation data format correlation.  The correlation format uses
	...
	*/
	...
	public:
		...
		* \param newtime - A double containting the new phase time to use
		...
		* \param neworigintime - A double containting the new origin time to use
		* \param neweventtype - A std::string containing the event type to use, empty string to omit
		* \param newmagnitude - A double containing the magnitude to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newsnr - A double containing the snr to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newzscore - A double containing the zscore to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newdetectionthreshold - A double containing the detection threshold to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newthresholdtype - A std::string containing the threshold type to use, empty string to omit
		*/
		correlation(std::string newid, std::string newsiteid, std::string newstation, std::string newchannel, std::string newnetwork, std::string newlocation,
			            std::string newagencyid, std::string newauthor, std::string newphase, double newtime, double newcorrelation, double newlatitude, double newlongitude,
			            double newdepth, double neworigintime, std::string neweventtype, double newmagnitude, double newsnr, double newzscore, double newdetectionthreshold,
		...
		* \param newassociatedresidual - A double containing the associated residual to use, std::numeric_limits<double>::quiet_NaN() to omit
		* \param newassociatedsigma - A double containing the associated sigma to use, std::numeric_limits<double>::quiet_NaN() to omit
		*/
		correlation(std::string newid, std::string newsiteid, std::string newstation, std::string newchannel, std::string newnetwork, std::string newlocation,
			std::string newagencyid, std::string newauthor, std::string newphase, double newtime, double newcorrelation, double newlatitude, double newlongitude,
			double newdepth, double neworigintime, std::string neweventtype, double newmagnitude, double newsnr, double newzscore, double newdetectionthreshold,
			std::string newthresholdtype, std::string newassociatedphase, double newassociateddistance, double newassociatedazimuth, double newassociatedresidual,
		...
		* \param newthresholdtype - A std::string containing the threshold type to use, empty string to omit
		*/
		correlation(std::string newid, detectionformats::site newsite, detectionformats::source newsource, std::string newphase, double newtime, 
			            double newcorrelation, double newlatitude, double newlongitude, double newdepth, double neworigintime, std::string neweventtype, double newmagnitude,
			            double newsnr, double newzscore, double newdetectionthreshold, std::string newthresholdtype);
		...
		*/
		correlation(std::string newid, detectionformats::site newsite, detectionformats::source newsource, std::string newphase, double newtime,
			double newcorrelation, double newlatitude, double newlongitude, double newdepth, double neworigintime, std::string neweventtype, double newmagnitude,
			double newsnr, double newzscore, double newdetectionthreshold, std::string newthresholdtype, detectionformats::associated newassociated);
		...
		*
		* A required detectionformats::site containing the site for this correlation message
		*/
		...
		*
		* A required detectionformats::source containing the source for this correlation message
		*/
		...
		*
		* A required double defining the correlation value for this correlation message
		*/
		...
		*
		* A required double defining the latitude of this correlation message
		*/
		double latitude;
		...
		*
		* A required double defining the longitude of this correlation message
		*/
		double longitude;
		...
		* \brief depth value
		*
		* A required double defining the detph of this correlation message
		*/
		double depth;

		/**
		* \brief correlation origin time
		*
		* A required double containing the origin time for this correlation message
		*/
		double origintime;
		...
		*
		* An optional std::string containing the event type of this correlation message
		...
		*
		* An optional double defining the detection threshold for this correlation message
		*/
		...
		*
		* An optional std::string defining the threshold type of  this correlation message
		*/
		...
		*
		* Optional detectionformats::associated containing the associated information for this correlation message
		*/
